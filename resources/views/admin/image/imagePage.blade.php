...
@section('content')
 <div class="container-fluid">
          ...
          <h1 class="h3 mb-2 text-gray-800">Image Page</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="float-right">
              ...
              <a href="{{url('admin/add/image/'.Auth::guard('admin')->user()->id)}}" class="btn btn-success">
                    ...
                    <tr>
                     ...
                     <td>{{\Carbon\Carbon::parse($image->created_at)->format('j F, Y') }}</td>
                       ...
                       <td class="align-items-center">
                         <div >
                         <div>
                         <a href="{{url('admin/image/edit/'.Auth::guard('admin')->user()->id.'/'.$image->id)}}" class="btn btn-success">
                          <samp class="iglyphicon  text-center">Edit</samp>
                        </a>
                         </div>
                         <div style="height:2pt" ></div>
                         <a href="{{url('admin/image/delete/'.Auth::guard('admin')->user()->id.'/'.$image->id)}}" class="btn btn-danger">
